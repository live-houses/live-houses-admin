...
ALTER TABLE
    "checkouts" ADD CONSTRAINT "checkouts_ticket_id_foreign" FOREIGN KEY("ticket_id") REFERENCES "ticket"("id");
ALTER TABLE
...
ALTER TABLE
    "checkouts" ADD CONSTRAINT "checkouts_checkout_id_foreign" FOREIGN KEY("checkout_id") REFERENCES "checkout"("id");
ALTER TABLE
    "checkout" ADD CONSTRAINT "checkout_account_id_foreign" FOREIGN KEY("account_id") REFERENCES "account"("id");